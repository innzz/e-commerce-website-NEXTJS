...
function Checkout({cart,addToCart,removeFromCart,clearCart,subtotal}) {
  return (
    <div className='container px-2 sm:m-auto'>
      ...
      <div className="mx-auto flex my-4">
        ...
        <div className="px-2 w-full" >
            ...
            <textarea name="address" id="address" cols="30" rows="2"  type="text"className="w-full bg-white rounded border border-gray-300 focus:border-green-500 focus:ring-2 focus:ring-green-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"></textarea>
            </div>
        </div>
    ...
    <div className="mx-4">
    <Link href={'/order'}><a><button className="flex mr-2 text-white bg-green-500 border-0 py-2 px-8 focus:outline-none hover:bg-green-600 rounded text-sm">Pay:- ₹{subtotal}</button></a></Link>
    </div>
    </div>
  )
}
